...
class Vektor
{
	...
	friend Vektor operator+ (Vektor a, Vektor b); //Ueberladen des +-Operators // friend bewirkt, dass man die Uerberladung ausserhalb der klasse machen kann weil i der kasse nimmt ne funktion 0-1 argument
